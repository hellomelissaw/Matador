...
public class BoardInit {
    ...
    public BoardInit(GuiController guiController, Text msg) {
        ...
        board[3] = new ChanceSquare(msg.getText("chance"),guiController);
        ...
        board[9] = new ChanceSquare(msg.getText("Chance"),guiController);
        ...
        board[15] = new ChanceSquare(msg.getText("chance"),guiController);
        ...
        board[21] = new ChanceSquare(msg.getText("chance"),guiController);
