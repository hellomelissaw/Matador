...
public class BoardInit {
    ...
    public BoardInit(GuiController guiController, Text msg, Player[] players) {
       ...
       // skrive metode board[4] = new TaxSquare(msg.getText("Betal indkomstskat: 10% eller 4000"),guiController, players
       // board[5] = new DeedSquare(msg.getText("Scandlines"),4000,guiController);
        ...
        // skrive metode board[38] = new TaxSquare(msg.getText("Betal 2000 kr i skat"),guiController, players
