...
public class ChanceSquare extends Square{
    ...
    public ChanceSquare(String squareName, GuiController guiController, Player[] players) { //INITIALISES DECK OF CHANCE CARDS
        ...
        chanceCards[43] = new CardJailPass("chance43",guiController);// I anledning af kongens fødselsdag benådes De herved for fængsel. Dette kort kan opbevares indtil De får brug for det, eller De kan sælge det. (waiting on updated jailsquare)
